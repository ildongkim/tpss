...
function fn_id_check(){	
	$.ajax({
		type:"POST",
		url:"<c:url value='/cmm/init/EgovIdDplctCnfirmAjax.do' />",
		data:{
...
function fnIdCheck1(){
    var retVal;
    var url = "<c:url value='/cmm/init/EgovIdDplctCnfirmView.do'/>";
...
<form:form commandName="mberManageVO" action="${pageContext.request.contextPath}/cmm/init/EgovMberSbscrb.do" name="mberManageVO"  method="post" onsubmit="fnInsert(document.forms[0]); return false;"> 
...
<!-- Egov Modal include  -->
<c:import url="/cmm/init/EgovModal.do" charEncoding="utf-8">
