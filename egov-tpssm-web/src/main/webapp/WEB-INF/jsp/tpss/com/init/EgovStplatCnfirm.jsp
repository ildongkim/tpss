...
<form name="QustnrManageForm" action="<c:url value='/cmm/init/EgovRlnmCnfirm.do'/>" method="post">
<div class="wTableFrm">
		<!-- 타이틀 -->
		<h2>${pageTitle}</h2>
        ...
        <c:if test="${sbscrbTy == 'USR01'}">"/cmm/init/EgovMberSbscrbView.do"</c:if>
        <c:if test="${sbscrbTy == 'USR02'}">"/cmm/init/EgovEntrprsMberSbscrbView.do"</c:if>
